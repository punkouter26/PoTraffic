...
public static class RouteOwnershipExtensions
{
    ...
    /// </summary>
    public static bool OwnsRoute(this TableStorageContext db, Guid routeId, Guid userId)
    ...
    /// </summary>
    public static HashSet<Guid> GetUserRouteIds(this TableStorageContext db, Guid userId)
